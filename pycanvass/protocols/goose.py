...
class BitString(ASNType):
    ...
    def __init__(self, data='', length=0):
        c = {'0': '0000', '1': '0001', '2': '0010', 
             ...
             'f':'1111'}
        self.padding = struct.unpack('>b', data[:1])[0]  # '\x00'+
    ...
    def pack(self):
        ...
        packed_data = struct.pack('>b', int(self.data, 2))
...
class Data(object):
    ...
    def __init__(self, data=None, length=0):
        ...
        self.tagmap[(128, 32, 11)] = ("integer", Data)
